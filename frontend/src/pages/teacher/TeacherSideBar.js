    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Teacher/assignments/upload">
                    <ListItemIcon>
                ...
                <ListItemButton component={Link} to="/Teacher/notes/upload">
                    <ListItemIcon>
                        <NoteAddIcon color={location.pathname.startsWith("/Teacher/notes") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
