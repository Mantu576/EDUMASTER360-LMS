        ...
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/assignments">
                    <ListItemIcon>
                        <AssignmentOutlinedIcon color={location.pathname.startsWith("/Student/assignments") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Assignments" />
                </ListItemButton>
                <ListItemButton component={Link} to="/Student/notes">
                    <ListItemIcon>
                        <NoteAltOutlinedIcon color={location.pathname.startsWith("/Student/notes") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Notes" />
                </ListItemButton>
                <ListItemButton component={Link} to="/Student/subjects/subjectID">
                    <ListItemIcon>
